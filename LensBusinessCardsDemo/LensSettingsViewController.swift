...
class LensSettingsViewController: UIViewController {
    ...
    let generalSection: [(Keys,Types)] = [(.autoLightDetectionIsOn, .switchCell), (.autoSubmitDocumentOnCapture, .switchCell), (.backupDocsToGallery, .switchCell), (.closeCameraOnSubmit, .switchCell)]
